...
import { Box, Typography, MenuItem, FormControl, TextField, Divider } from '@mui/material';
    ...
    return (
        <Box>
            <Box style={{ padding: '13px', overflow: 'auto' }}>
                ...
                <Typography variant="h5" gutterBottom sx={{ fontWeight: 'bold', fontSize: '15px' }}>
                    {product.mainTitle}
                </Typography>
                <Typography variant="h6" gutterBottom sx={{ fontWeight: 'medium', fontSize: '16px' }}>
                    Size
                </Typography>
                ...
                <Typography variant="h6" gutterBottom sx={{ fontWeight: 'regular', fontSize: '12px' }}>
                    {product.description}
                </Typography>
                <Typography variant="h6" gutterBottom sx={{ fontWeight: 'medium', fontSize: '16px' }}>
                    Price
                ...
                <Typography variant="h6" gutterBottom sx={{ fontWeight: 'bold' }}>
                    ₹ {product.price} <b style={{ marginLeft: '20px', color: 'red' }}>{product.discount}% Offer</b>
                </Typography>
            </Box>
            <Box style={{ position: 'sticky', bottom: 0, left: 0, width: '100%', background: 'white', borderTop: '1px solid #ccc' }}>
                <Button variant="contained" style={{ height: '50px', width: '100%', textAlign: 'center' }}>
                    <ShoppingCartIcon style={{ paddingRight: '10px' }} />Add to cart
                </Button>
            </Box>
        </Box>
    );
